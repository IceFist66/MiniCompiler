// $ANTLR 3.3 Nov 30, 2010 12:50:56 Mini.g 2014-04-09 10:01:57
...
public class MiniLexer extends Lexer {
    ...
    public String getGrammarFileName() { return "Mini.g"; }
    ...
    public final void mID() throws RecognitionException {
        try {
            int _type = ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Mini.g:97:10: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )* )
            // Mini.g:97:13: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' )*
            {
    ...
    public void mTokens() throws RecognitionException {
        // Mini.g:1:8: ( STRUCT | INT | BOOL | FUN | VOID | PRINT | ENDL | READ | IF | ELSE | WHILE | DELETE | RETURN | TRUE | FALSE | NEW | NULL | LBRACE | RBRACE | SEMI | COMMA | LPAREN | RPAREN | ASSIGN | DOT | AND | OR | EQ | LT | GT | NE | LE | GE | PLUS | MINUS | TIMES | DIVIDE | NOT | ID | INTEGER | WS | COMMENT )
        int alt6=42;
